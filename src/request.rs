...
///
/// The `Scope` is needed to ensure that all buffers associated with a request will outlive the
/// request itself, even if the destructor of the request fails to run.
///
/// # Panics
///
